...
import frc.robot.commands.ArrayDown;
import frc.robot.commands.ArraySelector;
import frc.robot.commands.ArrayUp;
import frc.robot.commands.ClawButtonCommand;
import frc.robot.commands.LockArm;
import frc.robot.commands.MoveArm;
import frc.robot.commands.ReverseToggle;
import frc.robot.commands.ShiftCommand;
import frc.robot.commands.ZeroArmJoint;
import frc.robot.commands.saystuff;
